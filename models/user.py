...
class User(UserMixin):
    def __init__(self, id, cnf_vinculado, email, cargo, senha_hash):
        self.id = id
    ...
    def get(user_id):
        ...
        if user_data:
            return User(user_data['id'], user_data['cnf_vinculado'], user_data['email'], user_data['cargo'], user_data['senha_hash'])
        return None
